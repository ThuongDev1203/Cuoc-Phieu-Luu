...
namespace Animation.State.Boss.Attack
{
    public class AttackBossState : BosState, IEnemyState
    {
       public AttackBossState(Boss5Control boss, BossStateMachine stateMachine) : base (boss, stateMachine)
        {
            this.boss = boss;
