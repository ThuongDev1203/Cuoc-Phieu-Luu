...
namespace Animation.State.Boss.Hit
{
    public class HitbossState : BosState, IEnemyState
    {
       public HitbossState(Boss5Control boss, BossStateMachine stateMachine) : base (boss, stateMachine)
        {
            this.boss = boss;
